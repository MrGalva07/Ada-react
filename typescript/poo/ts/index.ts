...
// As classes são abstrações utilizadas para criações de objetos que obedecem a um mesmo padrão.
// //Classes possuem atributos,métodos e um construtor que inicializa os atributos definidos
//O constructor também define um contrato para os objetos.
...
class Professor extends Pessoa{
    ...
    constructor(nome:string,idade:number,altura:number,cpf:string,code:string){
